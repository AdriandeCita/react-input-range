...
var _defaultClassNames_vertical = __webpack_require__(10);

var _defaultClassNames_vertical2 = _interopRequireDefault(_defaultClassNames_vertical);
...
var InputRange = (_class = function (_React$Component) {
  ...
  function InputRange(props) {
    ...
    if (_this.props.orientation === 'vertical') {
      _this.classNames = _defaultClassNames_vertical2.default;
    }
    return _this;
  }
  ...
  _createClass(InputRange, [{
    ...
    value: function getKeyByPosition(position) {
      ...
      var positions = valueTransformer.getPositionsFromValues(values, this.props.minValue, this.props.maxValue, this.getTrackClientRect(), this.props.orientation === 'vertical');
    ...
    value: function updatePositions(positions) {
      var values = {
        min: valueTransformer.getValueFromPosition(positions.min, this.props.minValue, this.props.maxValue, this.getTrackClientRect(), this.props.orientation === 'vertical'),
        max: valueTransformer.getValueFromPosition(positions.max, this.props.minValue, this.props.maxValue, this.getTrackClientRect(), this.props.orientation === 'vertical')
      };
    ...
    value: function handleSliderDrag(event, key) {
      ...
      var position = valueTransformer.getPositionFromEvent(event, this.getTrackClientRect(), this.props.orientation === 'vertical');
    ...
    value: function handleTrackDrag(event, prevEvent) {
      ...
      var position = valueTransformer.getPositionFromEvent(event, this.getTrackClientRect(), this.props.orientation === 'vertical');
      var value = valueTransformer.getValueFromPosition(position, minValue, maxValue, this.getTrackClientRect(), this.props.orientation === 'vertical');
      var stepValue = valueTransformer.getStepValueFromValue(value, this.props.step);

      var prevPosition = valueTransformer.getPositionFromEvent(prevEvent, this.getTrackClientRect(), this.props.orientation === 'vertical');
      var prevValue = valueTransformer.getValueFromPosition(prevPosition, minValue, maxValue, this.getTrackClientRect(), this.props.orientation === 'vertical');
    ...
    value: function renderSliders() {
      ...
      return keys.map(function (key) {
        ...
        var slider = _react2.default.createElement(_slider2.default, {
          ...
          classNames: _this3.classNames || _this3.props.classNames,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _label2.default,
          {
            classNames: this.classNames || this.props.classNames,
 ...
 * @type {InputRangeClassNames}
 */
var DEFAULT_VERTICAL_CLASS_NAMES = {
  activeTrack: 'input-range__track input-range__track--vertical input-range__track--active',
  disabledInputRange: 'input-range input-range--disabled',
  inputRange: 'input-range input-range--vertical',
  labelContainer: 'input-range__label-container input-range__label-container--vertical',
  maxLabel: 'input-range__label input-range__label--max',
  minLabel: 'input-range__label input-range__label--min',
  slider: 'input-range__slider',
  sliderContainer: 'input-range__slider-container',
  track: 'input-range__track input-range__track--vertical input-range__track--background input-range__track--background--vertical',
  valueLabel: 'input-range__label input-range__label--value'
};

exports.default = DEFAULT_VERTICAL_CLASS_NAMES;
module.exports = exports['default'];
...
var Track = (_class = function (_React$Component) {
  ...
  _createClass(Track, [{
    ...
    value: function getActiveTrackStyle() {
      var length = (this.props.percentages.max - this.props.percentages.min) * 100 + '%';
      var offset = this.props.percentages.min * 100 + '%';
    ...
    value: function handleMouseDown(event) {
      ...
      if (this.props.orientation === 'vertical') {
        ...
        var _trackClientRect = this.getClientRect();
        position = {
          x: clientX - _trackClientRect.left,
          y: 0
        };
      }
 ...
 */
function getPercentageFromPosition(position, clientRect, isVertical) {
  var length = isVertical ? clientRect.height : clientRect.width;
  var sizePerc = (isVertical ? position.y : position.x) / length;
...
function getValueFromPosition(position, minValue, maxValue, clientRect) {
  ...
  var sizePerc = getPercentageFromPosition(position, clientRect, isVertical);
 ...
 */
function getPositionFromValue(value, minValue, maxValue, clientRect, isVertical) {
  var length = isVertical ? clientRect.height : clientRect.width;
...
function getPositionFromEvent(event, clientRect) {
  var isVertical = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

  if (isVertical) {
    var _length = clientRect.height;
    ...
    return {
      x: 0,
      y: (0, _utils.clamp)(clientRect.bottom - clientY, 0, _length)
    };
  }
